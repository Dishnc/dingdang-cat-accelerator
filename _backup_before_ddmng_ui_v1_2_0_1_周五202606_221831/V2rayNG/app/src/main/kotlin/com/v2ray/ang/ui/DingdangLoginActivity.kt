...
class DingdangLoginActivity : AppCompatActivity() {
    companion object {
        ...
        private const val DEFAULT_SERVICE_BASE = "__DDMNG_API_BASE_URL__"
    }
    ...
    private fun resolveServiceBase(): String {
        ...
        if (configured.isNotEmpty() && !configured.contains("__DDMNG_API_BASE_URL__") && !configured.contains("CHANGE_ME")) {
            return configured
        }
